...
class Drive( MotorSafety ):
	...
	def enabledMotorFix(self):
		if self.enabled:
			self.FLMotor.set( self.MInfoFL.setPoint * ( -self.powerscale if self.MInfoFL.motorInverted else self.powerscale))
			self.FRMotor.set( self.MInfoFR.setPoint * ( -self.powerscale if self.MInfoFR.motorInverted else self.powerscale))
			self.RLMotor.set( self.MInfoRL.setPoint * ( -self.powerscale if self.MInfoRL.motorInverted else self.powerscale))
			self.RRMotor.set( self.MInfoRR.setPoint * ( -self.powerscale if self.MInfoRR.motorInverted else self.powerscale))
